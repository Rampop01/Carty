...
import { type ShoppingSession, getVoteCounts, getVotersForProduct } from "../shop/SessionState.js";
...
export function formatVotingUpdate(session: ShoppingSession): string {
...
export function formatFinalDecision(product: Product, votes: number, totalVotes: number): string {
  return [
