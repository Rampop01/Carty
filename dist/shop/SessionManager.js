...
import { createSession, getVoteCounts, getVotersForProduct, } from "./SessionState.js";
import { poll, richlink } from "spectrum-ts";
import { formatVotingUpdate, formatNoProductsFound, formatSessionAlreadyActive, formatNoActiveSession, } from "../utils/formatter.js";
export class SessionManager {
     ...
     */
    async startShopping(chatId, query, hostId, hostName, send) {
     ...
     */
    async castVote(chatId, playerId, playerName, productId, send) {
